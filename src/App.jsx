...
import { 
  Calculator, FileText, Menu, X, Layers, ArrowRight, RefreshCw, BookOpen, Printer, Trash2, Plus, Settings, Save, Edit3, Sliders, AlertCircle, Check, Info, Scale, Gavel, Book, AlertTriangle, TrendingUp, Sigma
} from 'lucide-react';
...
export default function App() {
  ...
  // State Data
  const [config, setConfig] = useState({ companyName: "PT. eSPeJe Ecosystem", ump: 5729876 });
                    ...
                    <div>
                        ...
                        <div className="text-blue-100 text-sm mt-1">
                          <ol className="list-decimal pl-4 space-y-1">
                            <li>Tentukan nilai jabatan.</li>
                            <li>Anda bisa mengatur kriteria penilaian sendiri.</li>
                          </ol>
                        </div>
                    </div>
        ...
        {activeTab === 'report' && (
            <div className="bg-white p-8 shadow-lg border rounded-xl animate-in fade-in slide-in-from-bottom-4 print:shadow-none print:border-none">
                <div className="text-center border-b-2 border-slate-800 pb-6 mb-8">
                    <h1 className="text-2xl font-bold uppercase text-slate-900">STRUKTUR UPAH DAN SKALA UPAH</h1>
                    <StableTextInput 
                    ...
                    />
                    <p className="text-xs text-slate-400 mt-2">Dicetak pada: {new Date().toLocaleDateString('id-ID', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</p>
                </div>
                
                {/* Tabel A: Struktur Upah - WRAPPED IN OVERFLOW-X-AUTO */}
                <div className="mb-8">
                    <h3 className="font-bold text-slate-800 mb-2 pl-3 border-l-4 border-slate-800">A. Tabel Struktur Upah dan Skala Upah</h3>
                ...
                <div className="mb-8 break-inside-avoid">
                    <h3 className="font-bold text-slate-800 mb-2 pl-3 border-l-4 border-slate-800">B. Detail Jabatan per Golongan</h3>
                    <div className="overflow-x-auto border border-slate-300 rounded-sm">
